...
const SideBar = () => {
  const [showSidleBar, setShowSidleBar] = useState(true);
  ...
  return (
    <div>
      <div
        ...
        onClick={() => setShowSidleBar((prev) => !prev)}
      >
        {showSidleBar ? <ImCancelCircle /> : <AiOutlineMenu />}
      </div>
      {showSidleBar && (
        <div className="xl:w-400 w-20 flex flex-col justify-start mb-10 border-r-2 border-gray-100 xl:border-0 p-3">
          ...
          {/* {!userProfile && (
            <div className="px-2 py-4 hidden xl:block ">
              <p className="text-gray-400 ">Login into like and comment on videos</p>
              <div className="pr-4">
                <GoogleLogin
                  clientId=""
                  render={(renderProps) => (
